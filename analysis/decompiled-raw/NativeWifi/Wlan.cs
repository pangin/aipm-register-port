...
public static class Wlan
{
	...
	public struct WlanRateSet
	{
		...
		public ushort[] Rates
		{
			get
			{
				ushort[] array = new ushort[rateSetLength / 2];
	...
	{
		private readonly WlanReasonCode _0;

		public WlanReasonCode ReasonCode => _0;
		...
		public override string Message
		{
			get
			{
				...
				if (WlanReasonCodeToString(_0, stringBuilder.Capacity, stringBuilder, IntPtr.Zero) != 0)
				{
					return string.Empty;
				}
	...
	[DllImport("wlanapi.dll")]
	public static extern int WlanDisconnect([In] IntPtr clientHandle, [In][MarshalAs(UnmanagedType.LPStruct)] Guid interfaceGuid, IntPtr pReserved);
	...
	[DebuggerStepThrough]
	internal static void _0(int P_0)
	{
		if (P_0 != 0)
		{
			throw new Win32Exception(P_0);
		}
	}
}
